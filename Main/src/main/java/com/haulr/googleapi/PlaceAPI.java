...
public class PlaceAPI {
    ...
    private static final String API_KEY = UILApplication.GOOGLE_SERVER_API_KEY;
    ...
    */
    ...
    /**
     *  Return results as a PlaceAutocomplete
     * @param input
     * @return
     */
    public ArrayList<PlaceAutocomplete> autocomplete (String input) {
        ...
        try {
            ...
            for (int i = 0; i < predsJsonArray.length(); i++) {
                ...
                id = predsJsonArray.getJSONObject(i).getString("place_id");
                description = predsJsonArray.getJSONObject(i).getString("description");
                resultList.add(new PlaceAutocomplete(id, description));
            }
        } catch (JSONException e) {
            Log.e(TAG, "Cannot process JSON results", e);
        }
